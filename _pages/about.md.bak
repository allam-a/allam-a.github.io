...
During my PhD, I 1) built systems that use ultrasound to transfer power and communicate underwater and through metals, 2) built acoustic meta-lenses built using desktop 3D printers to focus sound underwater and in-air, 3) developed piezoelectric transducers to provide simultaneous power and data to IoT sensors, and 4) developed new techniques to inspect 3D-printed metals using ultrasonic waves.
